...
public class ButtonOnClickRIGHT : MonoBehaviour {
    ...
    public void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Keypad1) || Input.GetKeyDown(KeyCode.Alpha1))  //Checks if we press 1,  then :-
        {
        ...
        if (Input.GetKeyDown(KeyCode.Keypad2) || Input.GetKeyDown(KeyCode.Alpha2))  //Checks if we press 2,  then :-
        {
        ...
        if (Input.GetKeyDown(KeyCode.Keypad3) || Input.GetKeyDown(KeyCode.Alpha3))  //Checks if we press 3,  then :-
        {
        ...
        if (Input.GetKeyDown(KeyCode.Keypad4) || Input.GetKeyDown(KeyCode.Alpha4))  //Checks if we press 4,  then :-
        {
